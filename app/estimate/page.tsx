...
/**
 * /estimate — V3 "holy-grail" pin-confirmed Gemini-painted flow.
 *
 * Customer journey:
 ...
 *      to start over.
 *
 * This is the canonical estimator. The legacy /estimate V1/V2 mirror
 * was retired in favor of this V3 pipeline; bookmarks to /estimate-v2
 * are redirected here by next.config.ts.
 */
