 ...
 *
 * Mix of policy pain points, warranty / code gotchas, and value
...
export const ROOFING_FACTS: readonly string[] = [
  "Florida providers commonly require roof replacement at 20–25 years to keep coverage active.",
  ...
  "Wind-mitigation inspections often save $400–$1,200 a year on Florida homeowners policy after a new roof.",
  ...
  "Florida property coverage premiums rose more than 100% from 2018 to 2024. Roof age is the single biggest lever to bring them back down.",
  "After 15 years, most asphalt roofs have lost enough granules that UV protection is materially reduced.",
  "Most claims for storm damage have a one-year filing window from the date of the event.",
] as const;
